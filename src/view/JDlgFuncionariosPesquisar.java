...
public class JDlgFuncionariosPesquisar extends javax.swing.JDialog {
  ...
  private JDlgFuncionarios jDlgFuncionarios;
    ...
    public JDlgFuncionariosPesquisar(java.awt.Frame parent, boolean modal) {
        ...
        List lista = (List) gdcb_funcionarioDAO.listAll();
        controllerFuncionarios.setList(lista);
        jTable1.setModel((TableModel) controllerFuncionarios);
    }

    public void setTelaAnterior( JDlgFuncionarios jDlgFuncionario) {
        this.jDlgFuncionarios = jDlgFuncionario;
    }
    /**
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        ...
        GdcbFuncionario funcionario =  controllerFuncionarios.getBean( jTable1.getSelectedRow() );
